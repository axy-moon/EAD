...
const RentOrder = () => {
  ...
  const handleSubmit = (e) => {
    ...
    console.log(itemCategory,itemType,itemId,availableQuantity,date,customerName,customerAddress,phoneNumber)
    ...
    return(
        ...
        <div className="right-addProduct">
          ...
          <div className="row">
            ...
            <div className="col75">
              <input type="text" id="date" name="date" onInput={(e)=>setDate(e.target.value)}/>
            </div>
          </div>
